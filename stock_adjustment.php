<?php 
    ...
    $stock_adjustment_list = $obj->getTableRecords($GLOBALS['stock_adjustment_table'], '', '', '');
    ...
    $cancelled_bill = $obj->getAllRecords($GLOBALS['stock_adjustment_table'], 'deleted', 1);
    $cancelled_count = count($cancelled_bill);

    $stock_adjustment_list = array(); $stock_adjustment_count = 0;
    $stock_adjustment_list = $obj->getTableRecords($GLOBALS['stock_adjustment_table'], '', '', '');
    if(!empty($stock_adjustment_list)){
        $stock_adjustment_count = count($stock_adjustment_list);
    }
?>
<!DOCTYPE html>
<html lang="en">
                                    ...
                                    <div class="card-header align-items-center">
                                        <div class="row justify-content-end p-2">
                                            <div class="col-lg-2 col-md-3 col-6">
                                                <div class="form-group pb-1">
                                                    <div class="form-label-group in-border pb-1">
                                                        <input type="date" name="from_date" class="form-control shadow-none" onchange="Javascript:checkDateCheck();table_listing_records_filter();" value="<?php if(!empty($from_date)) { echo $from_date; } ?>"  max="<?php if(!empty($current_date)) { echo $current_date; } ?>">
                                            ...
                                            <div class="col-lg-2 col-md-3 col-6">
                                                <div class="form-group pb-1">
                                                    <div class="form-label-group in-border pb-1">
                                                        <input type="date" name="to_date" class="form-control shadow-none" onchange="Javascript:checkDateCheck();table_listing_records_filter();" value="<?php if(!empty($to_date)) { echo $to_date; } ?>" max="<?php if(!empty($current_date)) { echo $current_date; } ?>">
                                                        <label>To Date</label>
                                                    </div>
                                                </div> 
                                            </div>
                                            <div class="col-lg-2 col-md-3 col-6">
                                                <div class="form-group pb-2">
                                                    <div class="form-label-group in-border">
                                                            <select name="from_store_id" class="select2 select2-danger smallfnt" data-dropdown-css-class="select2-danger" onchange="table_listing_records_filter();">
                                            ...
                                            <div class="col-lg-2 col-md-4 col-6 mb-3">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" name="search_text" style="height:34px;" placeholder="Search By Bill Number" aria-label="Search" aria-describedby="basic-addon2" onkeyup="table_listing_records_filter();">
