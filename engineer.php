<?php 
    ...
    if(isset($_SESSION[$GLOBALS['site_name_user_prefix'].'_user_id']) && !empty($_SESSION[$GLOBALS['site_name_user_prefix'].'_user_id'])) {
        ...
        if($_SESSION[$GLOBALS['site_name_user_prefix'].'_user_type'] == $GLOBALS['staff_user_type']) {
            ...
            $permission_module = $GLOBALS['engineer_module'];
                                        ...
                                        <div class="row justify-content-end p-2">
                                            <div class="col-lg-3 col-md-4 col-6">
                                                <div class="input-group">
                                                    <input type="text" name="search_text"  class="form-control" onkeyup="Javascript:table_listing_records_filter();" style="height:34px;" placeholder="Search By Engineer Name" aria-label="Search" aria-describedby="basic-addon2">
