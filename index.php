<?php 
    ...
    if(isset($_POST['name'])) {	
		...
		if(empty($valid_user) && $users_count == 0) {
            ...
            $columns = array('created_date_time', 'creator', 'creator_name', 'user_id', 'role_id', 'name', 'mobile_number', 'name_mobile', 'login_id', 'lower_case_login_id', 'password', 'admin','type', 'deleted');
            $values = array("'".$created_date_time."'", "'".$creator."'", "'".$creator_name."'", "'".$null_value."'", "'".$null_value."'", "'".$name."'", "'".$mobile_number."'", "'".$name_mobile."'", "'".$login_id."'", "'".$lower_case_login_id."'", "'".$password."'", "'".$admin."'","'".$type."'", "'0'");
            $entry_insert_id = $obj->InsertSQL($GLOBALS['user_table'], $columns, $values, 'user_id','', $action);	
            
            echo $entry_insert_id."ji";
...
<head>
    <meta charset="utf-8">
    <title>Dashboard | Sri Vijay Cars</title>
                ...
                <div class="col-lg-12">
                    <div class="text-center mt-4 text-white-50">
                        <a href="index.php" class="d-inline-block auth-logo">
                           <img src="images/logo.webp" class="img-fluid w-75" alt="Sri Vijay Cars" title="Sri Vijay Cars">
                        </a>
                    </div>
                </div>
            </div>
                                    ...
                                    <?php } else { ?>
                                        <div class="row">
                                            ...
                                            <div class="col-10 mx-auto">
                                                <div class="form-group mb-1 pb-3">
                                                    <div class="form-label-group in-border">
                                                        <input type="text" name="mobile_number" maxlength="10" class="form-control shadow-none" value="" placeholder="" onkeydown="Javascript:KeyboardControls(this,'mobile_number',10,'');">
                                        ...
                                        <div class="text-center">
                                            <button class="btn btn-danger w-25 submit_button" type="button" onClick="Javascript:SaveModalContent(event,'login_form', 'index.php', 'index.php');">Submit</button>
                                        </div>
                                    <?php } ?>
                                </div>
                            </div>
