            ...
            if(preg_match("/^\d+$/", $check_user_id_ip_address)) {
                ...
                if(empty($edit_id)) {
                    if(empty($prev_user_id)) {
                        ...
                        $columns = array('created_date_time', 'creator', 'creator_name', 'user_id', 'name', 'mobile_number', 'name_mobile', 'password', 'admin', 'type', 'role_id', 'login_id', 'lower_case_login_id','deleted');
                        $values = array("'".$created_date_time."'", "'".$creator."'", "'".$creator_name."'", "'".$null_value."'", "'".$name."'", "'".$mobile_number."'", "'".$name_mobile."'",  "'".$password."'", "'".$admin."'", "'".$type."'", "'".$role_id."'","'".$login_id."'", "'".$lower_case_login_id."'", "'0'");
                            ...
                            <td>
                                ...
                                <?php if (empty($edit_access_error) || empty($delete_access_error)) { ?>
                                    <div class="dropdown">
                                        ...
                                        if (empty($delete_access_error) && $linked_count == 0 && empty($data['admin'])) { ?>
