<?php 
    ...
    $total_records_list = $obj->GetSalesEntryReport($GLOBALS['bill_company_id'],$filter_party_id,$from_date, $to_date);
                                ...
                                <form name="sales_report_form" method="POST">
                                    <div class="row justify-content-end p-2">   
                                        ...
                                        <div class="col-lg-4 col-6">
                                            <button class="btn btn-success m-1" style="font-size:11px;" type="button" onClick="window.open('reports/rpt_sales_report_a4.php?filter_party_id=<?php echo $filter_party_id; ?>&from_date=<?php echo $from_date; ?>&to_date=<?php echo $to_date; ?>')"> <i class="fa fa-print"></i> Print </button>
