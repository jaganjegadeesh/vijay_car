<?php 
	...
	function combineAndSumUp ($myArray) {
		...
		foreach ($myArray as $nkey => $nvalue) {
			...
			foreach ($finalArray as $fkey => $fvalue) {
				if ( ($fvalue['tax_value'] == $nvalue['tax_value']) && ($fvalue['hsn_value'] == $nvalue['hsn_value']) && ($fvalue['invoice_number'] == $nvalue['invoice_number'])) {
					$has = true;
					$fk = $fkey;
					break;
				}
			...
			if ( $has === false ) {
				...
				$finalArray[$fk]['invoice_number'] = $nvalue['invoice_number'];
			}
    ...
    $total_records_list = $obj->GetSalesTaxReport($filter_party_id,$from_date,$to_date);
                                            ...
                                            <?php 
                                                ...
                                                if(!empty($total_records_list)) {
                                                    ...
                                                    foreach($total_records_list as $key => $data) {
                                                        ...
                                                        $rate_values =array(); $hsn_sac = ""; $party_state = ""; $tax_option =''; $sales_date = ""; 
                                                        $invoice_number = ""; $party_name = ""; $product_discount = array(); 
                                                        ...
                                                        $discount_value = ""; $invoice_number = ""; $net_total = 0; $product_ids = ""; $tax_value1 = ""; $grand_discount = 0; $sub_total = 0; $total_discount = 0; $company_state = ""; 
                                                        $final_amount =0;
                                                        ...
                                                        if(!empty($data['invoice_id']) && $data['invoice_id'] != $GLOBALS['null_value']) {
                                                        ...
                                                        for($j=0;$j < count($product_ids);$j++){
                                                            ...
                                                            // if(!empty($tax_value[$j])){
                                                                ...
                                                                $individual_tax[] = array('hsn_value' => $product_hsn_code,'tax_value' => $tax_value[$j], 'total_amount' => $each_row_Amount,'quantity_value' => $quantity[$j],'invoice_number' => $invoice_number);
                                                            // }
                                                        }
                                                        ...
                                                        array_multisort(array_column($individual_tax, "invoice_number"), SORT_ASC,array_column($individual_tax, "hsn_value"), SORT_ASC,array_column($individual_tax, "tax_value"), SORT_ASC, $individual_tax);
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-center px-2 py-2" style="border: 1px solid #000; text-align: center; padding: 2px 10px; font-size: 13px; vertical-align: middle; height: 30px;">
                                                                <?php 
                                                                    ...
                                                                    echo $invoice_number.' <br> '.$invoice_date;
                                                            ...
                                                            $tax_amount = 0; $tax_amount1 = 0; $strtax_value = ""; $k=0; $strtax_amount = 0; $product_hsn_sac =array(); $final_array = array(); $total_tax_value = 0; $tax_total =0; $tax_plus_value1 = 0; $grand_amount = 0; $hsn_sac = array();
                                                                ...
                                                                foreach($final_array as $tax_data) {
                                                                    ...
                                                                    $deleted = $obj->getTableColumnValue($GLOBALS['invoice_table'],'invoice_number',$data['invoice_number'],'deleted');
                                                                    $tax_per = 0;
...
<script>
    ...
    function ExportToExcel(type, fn, dl) {
        ...
        XLSX.writeFile(wb, fn || ('sales_tax_report.' + (type || 'xlsx')));
        window.open("sales_tax_report.php","_self");
    }
</script>