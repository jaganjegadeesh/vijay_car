...
<button type="button" data-bs-toggle="modal" data-bs-target="#CustomAddModal" class="d-none custom_add_modal_button"></button>
<!-- The Modal -->

<div class="modal fade" id="CustomAddModal" tabindex="-1" role="dialog" aria-hidden="true" >
...
<!-- The Modal -->
<div class="modal modal-lg fade" id="PaymentModal" data-bs-keyboard="false" data-bs-backdrop="static">
    <div class="modal-dialog">
        <div class="modal-content">
            <!-- Modal Header -->
            <div class="modal-header">
